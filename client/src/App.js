...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Capuccino Token for MiCafe</h1>

        <h2>Enable your account</h2>
        KYC: Address to allow: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handleInputChange} />
        <br/>[Only the account which deployed the contracts (hence, owner) can whitelist accounts]<br/>
        ...
        <button type="button" onClick={this.handleBuyToken}>Buy 1 more token</button>
      </div>
    );
  }
}
